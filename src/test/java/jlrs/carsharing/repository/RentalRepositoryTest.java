...
@Sql(scripts = "classpath:database/rentals/insert-rentals-to-rentals-table.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
...
public class RentalRepositoryTest {
    ...
    void findAllByActive_ValidInput_StatusActive() {
        ...
        assertEquals(2, actualRentalList.size());
    }
